...
const navItems = [
  { name: "Dashboard", path: "/analyst", icon: LayoutDashboard, exact: true },
  { name: "Unassigned Claims", path: "/analyst/unassigned", icon: Inbox },
  { name: "My Assignments", path: "/analyst/assignments", icon: ClipboardList },
  { name: "Settings", path: "/analyst/settings", icon: Settings },
];
...
export function AnalystSidebar({ isCollapsed, setIsCollapsed }: AnalystSidebarProps) {
